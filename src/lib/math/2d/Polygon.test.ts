...
test("Triangle.contains()", () => {
  ...
  for (let i = 0; i < 1000; i++) {
    const v = V(Math.random() * 675, Math.random() * 230).add(V(-25, 134));
...
test("Triangle.intersects()", () => {
  ...
  for (let i = 0; i < 1000; i++) {
    const v = V(Math.random() * 675, Math.random() * 230).add(V(-25, 134));
    const u = V(Math.random() * 675, Math.random() * 230).add(V(-25, 134));
    const w = V(Math.random() * 675, Math.random() * 230).add(V(-25, 134));
    const tp = Triangle(v, u, w);
    const c = V(Math.random() * 675, Math.random() * 230).add(V(-25, 134));
    const b = V(Math.random() * 675, Math.random() * 230).add(V(-25, 134));
    const a = V(Math.random() * 675, Math.random() * 230).add(V(-25, 134));
